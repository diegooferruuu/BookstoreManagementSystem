    ...
    public class CreateModel : PageModel
    {
        ...
        public IActionResult OnPost()
        {
            ...
            try
            {
                ...
                _userService.Create(user, generatedPassword, new List<string> { SelectedRole });
...
<body>
<div class='container'>
<div class='header'><h1>Bookstore Management System</h1></div>
<div class='content'>
<h2>¡Bienvenido!</h2>
...
<div class='warning'><strong>Importante:</strong> Guarda estas credenciales en un lugar seguro.</div>
